...
// Package certgen: a tool for generating test certificates on disk for use as
...
package certgen // import "github.com/hashicorp/consul/connect/certgen"
...
func main() {
	...
	// Create CA certs
	var prevCA *api.CARoot
	for i := 1; i <= numCAs; i++ {
		ca := TestCAWithKeyType(&testing.RuntimeT{}, prevCA, keyType, keyBits)
		...
		for _, svc := range services {
			certPEM, keyPEM := TestLeaf(&testing.RuntimeT{}, svc, ca)
