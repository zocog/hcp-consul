...
func (s *HTTPHandlers) healthServiceNodes(resp http.ResponseWriter, req *http.Request, healthType string) (interface{}, error) {
	...
	// TODO(jm): NET-5879 - confirm this check is valid
	...
	return s.fetchServiceNodes(resp, req, args, params)
}

func (s *HTTPHandlers) fetchServiceNodes(resp http.ResponseWriter, req *http.Request, args structs.ServiceSpecificRequest, params url.Values) (structs.CheckServiceNodes, error) {
