...
type Registry interface {
	...
	// Types returns the registered resource types.
	Types() []*pbresource.Type
}
...
func (r *TypeRegistry) Types() []*pbresource.Type {
	r.lock.RLock()
	defer r.lock.RUnlock()

	types := make([]*pbresource.Type, 0, len(r.registrations))
