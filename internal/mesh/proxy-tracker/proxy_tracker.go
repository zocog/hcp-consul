...
func (pt *ProxyTracker) Watch(proxyID *pbresource.ID,
	...
	proxysnapshot.SessionTerminatedChan, proxysnapshot.CancelFunc, error) {
...
func (pt *ProxyTracker) cancelWatchLocked(proxyReferenceKey resource.ReferenceKey, proxyStateChan chan proxysnapshot.ProxySnapshot, session proxysnapshot.Session) {
